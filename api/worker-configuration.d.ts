/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 485629e10b8f8bca4e508fcdc79e2d21)
// Runtime types generated with workerd@1.20250617.0 2025-06-17 durable_object_alarms
declare namespace Cloudflare {
  interface Env {
    FRONTEND_URL: string;
    ENVIRONMENT: string;
    CREATE_ROOM_API_KEY: string;
